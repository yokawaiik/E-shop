...
import com.YoKawaiiK.e_shop.UI.OrderFragment;
...
public class OrderActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.Orderframe,new OrderFragment()).commit();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.Home) {
            ...
            startActivity(new Intent(OrderActivity.this, FavouritesActivity.class));
    ...
    private void showCartIcon(){
        ...
        PageTitle.setText(R.string.oaPageTitle);
