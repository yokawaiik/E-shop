...
import com.YoKawaiiK.e_shop.Model.AdminOffer;
import com.YoKawaiiK.e_shop.R;
import com.YoKawaiiK.e_shop.UI.Activities.AdminAddOfferActivity;
import com.YoKawaiiK.e_shop.UI.Activities.EditOfferActivity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        OffersFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //here add button
                startActivity(new Intent(getActivity(), AdminAddOfferActivity.class));
